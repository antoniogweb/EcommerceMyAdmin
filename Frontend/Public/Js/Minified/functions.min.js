...
location.href=baseUrl+"/checkout";else aggiornaCarrello(undefined,!0)}})});$(".showcoupon").click(function(e){e.preventDefault();$("#coupon").slideToggle()});$(".showlogin").click(function(e){e.preventDefault();$("#login").slideToggle()});if(filtro_prezzo_slider){$('.nstSlider').each((function(){var e=$(this),i=function(i){e.find(".leftLabel").text(i[0]+"€"),e.find(".rightLabel").text(i[1]+"€")};e.slider({range:!0,min:Number(e.data("range_min")),max:Number(e.data("range_max")),values:[Number(e.data("cur_min")),Number(e.data("cur_max"))],create:function(o,n){e.find(".ui-slider-range").addClass("bar"),i(e.slider("values"))},slide:function(e,o){i(o.values)},stop:function(e,i){var o=$(".url_slider_prezzo").text();o=(o=o.replace("[DA]",i.values[0])).replace("[A]",i.values[1]),location.href=o}})}))}
