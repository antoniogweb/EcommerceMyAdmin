...
var attiva_icheck=!0;if(typeof password_regular_expression_caratteri_maiuscoli=="undefined")
...
var password_regular_expression_numero_caratteri=8;$=jQuery;function isInArray(elemento,haystack){var count=haystack.length;for(var i=0;i<count;i++){if(haystack[i]==elemento){return!0}}
return!1}
...
$("body").on("click",".mostra_nascondi_password",function(e){e.preventDefault();var box=$(this).parent();if($(this).hasClass("mostra_password")){box.find("input[type='password']").attr("type","text");box.find(".mostra_password").addClass("uk-hidden");box.find(".nascondi_password").removeClass("uk-hidden")}else{box.find("input[type='text']").attr("type","password");box.find(".mostra_password").removeClass("uk-hidden");box.find(".nascondi_password").addClass("uk-hidden")}});$("body").on("click",".help_wizard_password",function(e){$(".box_avvisi_password").addClass("uk-hidden")});$("body").on("keyup",".help_wizard_password",function(e){var box=$(this).parent();var boxAvviso=box.find(".box_avvisi_password");if(boxAvviso.length){if(!checkPassword($(this)))
boxAvviso.removeClass("uk-hidden");else boxAvviso.addClass("uk-hidden")}});$("body").on("keydown",".help_wizard_password",debounce(function(e){var box=$(this).parent();var boxAvviso=box.find(".box_avvisi_password");if(boxAvviso.length)
boxAvviso.addClass("uk-hidden");},5000))})