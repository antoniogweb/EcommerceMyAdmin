...
setTimeout(function(){$(".btn_submit_form").removeClass("uk-hidden").parent().find(".spinner").addClass("uk-hidden")},300)}})});$("body").on("click",".invia_nuovamente_link",function(e){e.preventDefault();var that=$(this);var idLink=that.attr("data-id-link");var url=that.attr("href");$.ajaxQueue({type:"POST",data:{id:idLink,csrf_token:csrf_token},url:url,async:!0,cache:!1,dataType:"json",success:function(content){alert(content.errore);aggiornaListaLink();setTimeout(function(){$(".btn_submit_form").removeClass("uk-hidden").parent().find(".spinner").addClass("uk-hidden")},300)}})});$("body").on("click",".pulsante_disattiva_lista",function(e){if(confirm("Confermi? La lista non sarà più visibile e nessuno potrà acquistare i prodotti che hai selezionato nella lista"))
