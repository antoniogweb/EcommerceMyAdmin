...
function mostraTendinaAvvisoCambioListino(){UIkit.modal("#modal-listini").show()}
...
reloadWishlistSecondario()}})});$(".link_carrello").hover(function(){$("#carrello_secondario").css("display","block")},function(){$("#carrello_secondario").css("display","none")});if($("#modal-listini").length>0&&$("#modal-listini").hasClass("modal-listini-open"))
