...
azione_carrello=principale.attr('azione-carrello');var url=baseUrl+"/carrello/"+azione_carrello+"/"+id_page+"/"+quantity+"/"+id_c+"/"+id_p+"/"+id_cart;$.ajaxQueue({url:url,async:!0,cache:!1,dataType:"json",type:"POST",data:{json_pers:json_pers,id_lista:id_lista,csrf_token:csrf_token},success:function(content){clearTimeout(time);if(jQuery.trim(content.result)=="OK"){if(pixel&&typeof content.contens_fbk!="undefined"&&content.contens_fbk!=""){if(typeof fbq!=='undefined'){if(debug_js)
...
url+="?incrementa";$.ajaxQueue({url:url,type:"POST",data:{products_list:products_list,elementi_carrello:elementi,csrf_token:csrf_token},async:!0,cache:!1,dataType:"json",success:function(content){pulisciErroriCart();for(var i=0;i<content.qty.length;i++){evidenziaErroreCart(".item_quantity[rel='"+content.qty[i]+"']")}
