...
// 		'regusers,infoaccount',
		...
		'regusers,immagine',
		'regusers,logincomeutente',
		'regusers,twofactor',
		'regusers,twofactorsendmail',
		'regusers,twofactorcheck',
		'regusers,rinnovo',
		'riservata,index',
		'riservata,ordini',
		...
		'listeregalo,resolista',
		'feed,prodotti',
		'motoriricerca,cerca',
		'motoriricerca,ricercasemantica',
		'captcha,index',
		'promozioni,index',
		'promozioni,gestisci',
		'promozioni,modifica',
...
// 		'riservata,cancellaaccount',
	...
	public static $map = array(
		...
		'documenti-riservati/?'		=>	'riservata/documentiriservati',
		'gestione-crediti/?'		=>	'riservata/crediti',
		'user-notifications/?'		=>	'riservata/notifiche',
// 		'riservata/cancellaaccount'	=>	'riservata/cancellaaccount',
		...
		'regusers/eliminaapprovazione/(.*)'	=>	'regusers/eliminaapprovazione/${1}',
		'regusers/logincomeutente/(.*)'	=>	'regusers/logincomeutente/${1}',
		'regusers/twofactor/?'		=>	'regusers/twofactor',
		'regusers/twofactorsendmail/?'	=>	'regusers/twofactorsendmail',
		'regusers/twofactorcheck/?'	=>	'regusers/twofactorcheck',
		'account-renewal/(.*)'		=>	'regusers/rinnovo/${1}',
...
// 		'info-account.html'			=>	'regusers/infoaccount',
		...
		'grazie-per-l-acquisto-satispay'	=>	'ordini/ritornodasatispay',
...
// 		'ordini/simulapaypal'		=>	'ordini/simulapaypal',
		...
		'notifica-pagamento-klarna'	=>	'ordini/ipnklarna',
		'notifica-pagamento-satispay'	=>	'ordini/ipnsatispay',
		'resoconto-acquisto/(.*)'	=>	'ordini/summary/${1}',
		'pdf-ordine/(.*)'			=>	'ordini/pdfordine/${1}',
		'reso-ordine/(.*)'			=>	'ordini/resoordine/${1}',
		'redirect-to-gateway/(.*)'	=>	'ordini/topagamento/${1}',
		'checkout'					=>	'ordini/index',
		'autenticazione'			=>	'ordini/checklogin',
		'ordini/totale'				=>	'ordini/totale',
		'ordini/pagamenti/(.*)'		=>	'ordini/pagamenti/${1}',
		...
		'thumb/assistant/(.*)'		=>	'thumb/assistant/${1}',
		...
		'contenuti/recuperacarrello/(.*)'	=>	'contenuti/recuperacarrello/${1}',
		...
		'contenuti/jsonprovince/([A-Za-z]{2})'		=>	'contenuti/jsonprovince/${1}',
		...
		'cron/logtecnici'			=>	'cron/logtecnici',
		'cron/ai'					=>	'cron/ai',
		'motoriricerca/cerca/(.*)'	=>	'motoriricerca/cerca/${1}',
		'motoriricerca/ricercasemantica/?'	=>	'motoriricerca/ricercasemantica',
