...
<div class="uk-text-left" uk-grid>
	<div class="uk-width-1-1 uk-width-1-4@s uk-text-left">
		...
		<div class="uk-grid uk-margin-remove-top uk-grid-small uk-child-width-1-2" uk-grid>
			<div class="uk-text-small"><?php echo gtext("Scadenza");?></div> <div class="uk-margin-remove-top uk-text-small uk-text-emphasis"><?php echo smartDate($lista["liste_regalo"]["data_scadenza"]);?></div>
		</div>
		<div class="uk-grid uk-margin-remove-top uk-grid-small uk-child-width-1-2" uk-grid>
			<div class="uk-text-small"><?php echo gtext("Codice");?></div> <div class="uk-margin-remove-top uk-text-small uk-text-emphasis"><?php echo $lista["liste_regalo"]["codice"];?></div>
		</div>
		<?php if(in_array($lista["liste_regalo_tipi"]["id_lista_tipo"], ListeregalotipiModel::campoPresenteInTipi("nominativo", ""))) { ?>
		<div class="uk-grid uk-margin-remove-top uk-grid-small uk-child-width-1-2" uk-grid>
			<div class="uk-text-small"><?php echo gtext("Nominativo");?></div> <div class="uk-margin-remove-top uk-text-small uk-text-emphasis"><?php echo $lista["liste_regalo"]["nominativo"];?></div>
		</div>
		<?php } ?>
		<?php if(in_array($lista["liste_regalo_tipi"]["id_lista_tipo"], ListeregalotipiModel::campoPresenteInTipi("nome_bambino", ""))) { ?>
		<div class="uk-grid uk-margin-remove-top uk-grid-small uk-child-width-1-2" uk-grid>
			<div class="uk-text-small"><?php echo gtext("Nome bimbo/a");?></div> <div class="uk-margin-remove-top uk-text-small uk-text-emphasis"><?php echo $lista["liste_regalo"]["nome_bambino"];?></div>
		</div>
		<?php } ?>
		<?php if(in_array($lista["liste_regalo_tipi"]["id_lista_tipo"], ListeregalotipiModel::campoPresenteInTipi("genitore_1", ""))) { ?>
		<div class="uk-grid uk-margin-remove-top uk-grid-small uk-child-width-1-2" uk-grid>
			<div class="uk-text-small"><?php echo gtext("Genitore 1");?></div> <div class="uk-margin-remove-top uk-text-small uk-text-emphasis"><?php echo $lista["liste_regalo"]["genitore_1"];?></div>
		</div>
		<?php } ?>
		<?php if(in_array($lista["liste_regalo_tipi"]["id_lista_tipo"], ListeregalotipiModel::campoPresenteInTipi("genitore_2", ""))) { ?>
		<div class="uk-grid uk-margin-remove-top uk-grid-small uk-child-width-1-2" uk-grid>
			<div class="uk-text-small"><?php echo gtext("Genitore 2");?></div> <div class="uk-margin-remove-top uk-text-small uk-text-emphasis"><?php echo $lista["liste_regalo"]["genitore_2"];?></div>
		</div>
		<?php } ?>
		...
		<div class="uk-grid uk-margin-remove-top uk-grid-small uk-child-width-1-2" uk-grid>
			<div class="uk-text-small"><?php echo gtext("Data evento");?></div> <div class="uk-margin-remove-top uk-text-small uk-text-emphasis"><?php echo smartDate($lista["liste_regalo"]["data_nascita"]);?></div>
		</div>
		<?php } ?>
		...
		<div class="uk-grid uk-margin-remove-top uk-grid-small uk-child-width-1-2" uk-grid>
			<div class="uk-text-small"><?php echo gtext("Data evento");?></div> <div class="uk-margin-remove-top uk-text-small uk-text-emphasis"><?php echo smartDate($lista["liste_regalo"]["data_battesimo"]);?></div>
		</div>
		<?php } ?>
	</div>
