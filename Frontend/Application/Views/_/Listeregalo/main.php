	...
	<div class="uk-width-1-5@m">
		<div class="uk-flex uk-flex-middle uk-grid-small uk-child-width-1-5 uk-child-width-1-3@m uk-child-width-expand@s uk-grid" uk-grid="">
			...
			<div class="uk-margin-remove-top uk-text-center@s">
				...
				<a class="uk-text-danger uk-padding-small uk-text-bold td_edit csrf_post" data-post-valore="N" data-post-id_lista="<?php echo (int)$lista["liste_regalo"]["id_lista_regalo"];?>" title="<?php echo gtextAttr("Disattiva la lista",false);?>" href="<?php echo $this->baseUrl."/liste-regalo/";?>"><span class="uk-icon"><?php include tpf("Elementi/Icone/Svg/close.svg");?></span></a>
				<?php } else { ?>
				<a class="uk-padding-small uk-text-bold td_edit csrf_post" data-post-valore="Y" data-post-id_lista="<?php echo (int)$lista["liste_regalo"]["id_lista_regalo"];?>" title="<?php echo gtextAttr("Attiva la lista",false);?>" href="<?php echo $this->baseUrl."/liste-regalo/";?>"><span class="uk-icon uk-text-meta"><?php include tpf("Elementi/Icone/Svg/ban.svg");?></span></a>
				<?php } ?>
			</div>
		</div>
	</div>
