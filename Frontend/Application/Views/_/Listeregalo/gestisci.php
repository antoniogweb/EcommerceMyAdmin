...
<div class="uk-width-1-1 uk-flex uk-flex-top uk-grid" uk-grid>
    ...
    <div class="uk-width-1-1 uk-width-2-3@m">
		<ul class="uk-subnav uk-subnav-divider uk-flex-right@s">
			...
			<li><a target="_blank" href="<?php echo $this->baseUrl."/".ListeregaloModel::getUrlAlias($lista["id_lista_regalo"]);?>" share-text="<?php echo gtextAttr("Lista regalo");?>" share-title="<?php echo altUrlencode($lista["titolo"]);?>" class="share-link uk-button uk-button-link"><span class="uk-icon"><?php include tpf("Elementi/Icone/Svg/social.svg");?></span> <?php echo gtextPlain("Condividi");?></a></li>
