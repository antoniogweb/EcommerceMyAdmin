...
<p><?php echo gtext("Le sarà possibile impostare una nuova password al seguente");?> <a href="<?php echo Url::getRoot()."reimposta-password/$forgot_token"; ?>"><?php echo gtext("indirizzo web");?></a>.</p>
