	...
	<div class="uk-grid-column-small uk-child-width-1-2@s" uk-grid>
		...
		<div class="uk-margin uk-margin-remove-bottom">
			...
			<div class="uk-form-controls">
				...
				<?php echo Html_Form::input("dprovincia_spedizione",$values['dprovincia_spedizione'],"uk-input class_dprovincia_spedizione",null,"placeholder='".gtextAttr("Provincia", false)."'");?>
			</div>
		</div>
