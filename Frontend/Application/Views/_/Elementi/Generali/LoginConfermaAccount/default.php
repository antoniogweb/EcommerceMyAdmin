...
<div class="form_account_confirmation">
	<h4 class=""><?php echo gtextPlain("Per completare la verifica digita nel campo sottostante il codice a ".v("conferma_registrazione_numero_cifre_codice_verifica")." cifre");?><br /><?php echo gtextPlain("che è stato inviato all'indirizzo");?><b> <?php echo partiallyHideEmail($user["username"]);?></b></h4>
	<br />
	<div class="uk-child-width-1-3@m uk-text-center uk-flex uk-flex-center">
		<div>
			...
			<br /><a href="<?php echo $this->baseUrl."/send-confirmation";?>"><?php echo gtextPlain("Invia nuovamente il codice a ".v("conferma_registrazione_numero_cifre_codice_verifica")." cifre");?> <span class="uk-icon"><?php include tpf("Elementi/Icone/Svg/mail.svg");?></span></a>
			<?php } ?>
		</div>
	</div>
</div>