...
<div class="uk-margin uk-width-1-1">
	<div class="uk-grid uk-grid-collapse" uk-grid>
		<div class="uk-width-1-1 uk-width-1-2@m">
			...
			<br /><span class="uk-text-emphasis"><?php echo gtext("Indirizzo");?>:</span> <?php echo $ordine["indirizzo"];?>
			<br /><?php echo $ordine["cap"];?>, <?php echo $ordine["citta"];?> (<?php echo $ordine["nazione"] == "IT" ? $ordine["provincia"] : $ordine["dprovincia"];?>)
