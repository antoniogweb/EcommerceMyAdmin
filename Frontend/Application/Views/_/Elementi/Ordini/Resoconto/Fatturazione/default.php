...
<div class="uk-overflow-auto">
	<table class="table uk-table uk-table-divider uk-table-hover">
		...
		<tr>
			<td class="first_column"><?php echo gtextPlain("Nome", false); ?></td>
			<td><?php echo $ordine["nome"];?></td>
		</tr>
		<tr>
			<td class="first_column"><?php echo gtextPlain("Cognome", false); ?></td>
			<td><?php echo $ordine["cognome"];?></td>
		</tr>
		<?php } ?>
		<?php if (strcmp($ordine["tipo_cliente"],"azienda") === 0) { ?>
		<tr>
			<td class="first_column"><?php echo gtextPlain("Ragione sociale", false); ?></td>
		...
		<?php if ($ordine["p_iva"]) { ?>
			...
			<tr>
				<td class="first_column"><?php echo gtextPlain("P. IVA", false); ?></td>
		...
		<tr>
			<td class="first_column"><?php echo gtextPlain("Codice fiscale", false); ?></td>
		...
		<?php } ?>
		<tr>
			<td class="first_column"><?php echo gtextPlain("Email", false); ?></td>
			<td><?php echo $ordine["email"];?></td>
		</tr>
		<?php if ($ordine["pec"]) { ?>
		<tr>
			<td class="first_column"><?php echo gtextPlain("Pec", false); ?></td>
			<td><?php echo $ordine["pec"];?></td>
		</tr>
		<?php } ?>
		<?php if ($ordine["codice_destinatario"]) { ?>
		<tr>
			<td class="first_column"><?php echo gtextPlain("Codice destinatario", false); ?></td>
