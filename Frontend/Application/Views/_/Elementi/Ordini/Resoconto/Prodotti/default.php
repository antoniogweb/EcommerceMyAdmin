...
<div class="uk-overflow-auto">
	<table width="100%" class="uk-table uk-table-divider uk-table-hover" cellspacing="0">
		...
		<tr class="cart_item_row">
			...
			<?php } ?>
			<td colspan="<?php if (!$p["righe"]["id_p"]) { ?>2<?php } else { ?>1<?php } ?>" class="cart_item_product row_left"><?php echo $ordine["tipo_ordine"] != "W" ? $p["righe"]["title"] : PagesModel::getPageLocalizedTitle($p["righe"]["id_page"], $p["righe"]["title"]);?>
