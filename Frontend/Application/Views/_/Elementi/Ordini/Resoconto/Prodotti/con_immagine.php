...
<div class="uk-overflow-auto lista-riga uk-grid-small uk-child-width-1-2 uk-child-width-1-2@m <?php if (!User::$isMobile) { ?>uk-flex-middle<?php } ?> uk-grid" uk-grid>
	<div class="uk-first-column">
		<div class="uk-grid-small uk-child-width-1-1 uk-child-width-1-2@m uk-flex-middle uk-grid uk-text-uppercase" uk-grid="">
			<div>
	...
	<div class="uk-width-expand">
		<div class="uk-flex uk-flex-middle uk-grid-small uk-child-width-1-1 uk-child-width-expand@s uk-text-center@m uk-text-left uk-grid" uk-grid="">
			...
			<div class="uk-text-small">
				<span class="uk-hidden@m uk-text-bold"><?php echo gtext("Codice");?>:</span> <?php echo $p["righe"]["codice"];?>
			</div>
			<?php } ?>
			<div class="uk-text-small uk-margin-remove-top">
				<span class="uk-hidden@m uk-text-bold"><?php echo gtext("Prezzo");?>:</span>
			...
			<div class="uk-text-small uk-margin-remove-top">
				<span class="uk-hidden@m uk-text-bold"><?php echo gtext("Quantità");?>:</span> <?php echo $p["righe"]["quantity"];?>
			</div>
			<div class="uk-text-small uk-text-right@m uk-text-left uk-margin-remove-top">
				<span class="uk-hidden@m uk-text-bold"><?php echo gtext("Totale");?>:</span> &euro; <span class="item_price_subtotal"><?php echo setPriceReverse(p($p["righe"],$p["righe"]["quantity"] * $p["righe"]["price"]));?></span>
			</div>
		</div>
	</div>
</div>
