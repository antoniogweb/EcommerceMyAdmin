...
$titoloPagina = gtextPlain("Reso dell'ordine")." #".$ordine["id_o"];
...
<?php if ($periodo["richiesta"]) { ?>
	...
	<?php echo gtextPlain("hai eseguito un richiesta di reso per l'ordine")." <b>".$ordine["id_o"]; ?></b>
...
<?php } else { ?>
	...
	<form action="<?php echo OrdiniperiodiresoModel::g(false)->getUrlRichiediReso($periodo["id_o_periodo_reso"]);?>" method="POST">
		<button type="submit" class="uk-button uk-button-primary">
			<?php echo gtextPlain("Conferma la richiesta di reso dell'ordine", false)." ".$ordine["id_o"]; ?>
			<?php if ($periodo["id_spedizione_negozio"]) { echo " - ". gtext("merce consegnata il")." ".smartDate($periodo["data_inizio"], v("default_date_format"));} ?>
	...
	<br />
	<span class="uk-text-small"><?php echo gtextPlain("Il reso può essere richiesto nel seguente periodo:");?> <?php echo smartDate($periodo["data_inizio"], v("default_date_format"));?> - <b><?php echo smartDate($periodo["data_fine"], v("default_date_format"));?></b><br /></span>
	<?php } ?>
	<?php } ?>
<?php } ?>
