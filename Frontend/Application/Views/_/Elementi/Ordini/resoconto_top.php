...
<p class="uk-text-muted uk-text-small"><?php echo gtext("Può controllare in qualsiasi momento i dettagli dell'ordine al");?> <a href="<?php echo $baseUrl."resoconto-acquisto/".$ordine["id_o"]."/".$ordine["cart_uid"]."/".$ordine["admin_token"];?>?n=y"><?php echo gtext("seguente indirizzo web");?></a>.</p>
<?php } ?>
