	...
	<div class="uk-text-left uk-panel uk-background-muted uk-padding-small uk-position-relative uk-margin-medium-bottom">
		<dl class="uk-description-list uk-text-left uk-margin-remove-top uk-margin-remove-bottom">
			<dt class="uk-text-danger">
				...
				<?php echo gtextPlain("Attenzione: hai acquistato i seguenti prodotti partendo dalla lista");?>
				<?php } else { ?>
				<?php echo gtextPlain("Attenzione: hai inserito nel carrello i prodotti partendo dalla lista");?>
				<?php } ?>
				<b><?php echo $lista["titolo"];?></b>
			</dt>
			<dd class="uk-text-small"><?php echo gtextPlain("I prodotti acquistati verranno automaticamente consegnati al titolare della lista suddetta.")?></dd>
			<dd class="uk-text-small"><?php echo gtextPlain("Se si desidera consegnare personalmente i regali, si prega di passare a ritirarli in negozio.")?></dd>
		</dl>
		<?php if (!isset($ordine)) { ?>
