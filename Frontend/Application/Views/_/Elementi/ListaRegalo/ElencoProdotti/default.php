			...
			<div class="uk-text-meta uk-grid-small uk-child-width-1-5 uk-flex-middle uk-grid" uk-grid="">
				...
				<div class="uk-width-expand">
					<div class="uk-flex uk-flex-middle uk-grid-small uk-child-width-1-1 uk-child-width-expand@s uk-text-center uk-grid" uk-grid="">
						...
						<div>
							<?php echo gtextPlain("Prezzo");?>
						</div>
						<div>
							<?php echo gtextPlain("Quantità da acquistare");?>
						</div>
						<div>
				...
				<div class="uk-width-expand">
					<div class="uk-flex uk-flex-middle uk-grid-small uk-child-width-1-1 uk-child-width-expand@s uk-text-center@m uk-text-left uk-grid" uk-grid="">
						...
						<div class="uk-text-small">
							<span class="uk-hidden@m uk-text-bold"><?php echo gtextPlain("Prezzo");?>:</span> <?php if ($prezzoPienoIvato != $prezzoFinaleIvato) { echo "<del>$stringaDa € ".setPriceReverse($prezzoPienoIvato)."</del> € ".setPriceReverse($prezzoFinaleIvato); } else { echo "$stringaDa € ".setPriceReverse($prezzoFinaleIvato);}?> €
						</div>
						<div class="uk-text-small">
							<span class="uk-hidden@m uk-text-bold"><?php echo gtextPlain("Quantita da acquistare");?>:</span>
							<?php
						...
						<div class="uk-text-small">
							<span class="uk-hidden@m uk-text-bold"><?php echo gtextPlain("Quantita desiderata");?>:</span> <?php echo $numeroDesiderati;?>
						</div>
						<div class="uk-text-small">
						...
						<div>
							<?php if ($numeroRimastiDaRegalare > 0) { ?>
								...
								<?php } else { ?>
									<span class="uk-text-secondary uk-text-small uk-text-bold"><?php echo gtextPlain("Il prodotto non è più acquistabile");?></span>
								<?php } ?>
							<?php } else { ?>
								<span class="uk-text-secondary uk-text-small uk-text-bold"><?php echo gtextPlain("Già regalato");?></span>
							<?php } ?>
						</div>
					</div>
				</div>
...
<?php } else { ?>
	<div class="uk-text-center"><?php echo gtextPlain("Questa lista non contiene alcun prodotto da regalare.");?></div>
<?php } ?>
