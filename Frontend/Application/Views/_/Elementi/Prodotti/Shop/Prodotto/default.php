		...
		<div class="uk-position-top-right blocco_wishlist">
			<div class="uk-transition-fade">
				<div class="not_in_wishlist  show" style="<?php if (WishlistModel::isInWishlist($p["pages"]["id_page"])) { ?>display:none<?php } ?>;">
					<a data-link="<?php echo $this->baseUrl."/wishlist/aggiungi/".$p["pages"]["id_page"];?>" title='<?php echo gtextAttr("Aggiungi alla lista dei desideri", false);?>' href="#" rel="nofollow" class="uk-text-secondary azione_wishlist"><span class="uk-icon"><?php include tpf("Elementi/Icone/Svg/cuore.svg");?></span></a>
				</div>
			</div>
			<div class="in_wishlist  hide" style="<?php if (!WishlistModel::isInWishlist($p["pages"]["id_page"])) { ?>display:none<?php } ?>;">
				<a data-link="<?php echo $this->baseUrl."/wishlist/elimina/".$p["pages"]["id_page"];?>" class="uk-text-danger azione_wishlist" title='<?php echo gtextAttr("Elimina dalla lista dei desideri", false);?>' href="#" rel="nofollow"><span class="uk-icon"><?php include tpf("Elementi/Icone/Svg/cuore.svg");?></span></a>
			</div>
		</div>
