...
<a class="bo-social-twitter" href="https://twitter.com/share?url=<?php echo $this->baseUrl."/$urlAlias";?>&amp;text=<?php echo $p["pages"]["title"];?>" target="_blank" title="<?php echo gtext("Condividi su on Twitter");?>">
