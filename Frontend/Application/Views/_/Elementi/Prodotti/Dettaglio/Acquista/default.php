...
<div class="info-product">
	...
	<div class="uk-margin">
		<ul class="uk-list uk-text-small uk-margin-remove">
			...
			<li><span class="uk-text-muted"><?php echo gtextPlain("Codice");?>: </span><span class="codice_value"><?php echo $p["pages"]["codice"];?></span></li>
			<?php } ?>
			<li><span class="uk-text-muted"><?php echo gtextPlain("Peso");?>: </span><span class="peso_value"><?php echo setPriceReverse($p["pages"]["peso"]);?></span> kg</li>
			<?php if (isset($marchioCorrente) && count($marchioCorrente) > 0) { ?>
			<li><span class="uk-text-muted"><?php echo gtextPlain("Marchio");?>: </span><a href='<?php echo $this->baseUrl."/".getMarchioUrlAlias($marchioCorrente["marchi"]["id_marchio"]);?>'><?php echo mfield($marchioCorrente,"titolo");?></a></li>
			<?php } ?>
