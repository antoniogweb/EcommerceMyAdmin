...
<div class="uk-container uk-container-small uk-margin-medium-bottom">
    ...
    <form action="<?php echo Domain::$currentUrl;?>#newsletter-form" class="uk-container uk-container-xsmall" method="post" novalidate="novalidate">
        <div uk-grid>
			<div class="uk-width-3-4@m uk-width-3-4@s"><?php echo Html_Form::input("email",Form::$values["email"],"uk-width-expand uk-input uk-flex-first class_email","email","placeholder='".gtext("Il tuo indirizzo email*")."'");?></div>
