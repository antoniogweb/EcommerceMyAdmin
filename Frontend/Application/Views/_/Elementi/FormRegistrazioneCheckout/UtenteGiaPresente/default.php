...
<?php echo gtextPlain("Può eseguire il login (se non ricorda la password può impostarne una nuova al seguente",false);?> <a href='<?php echo Url::getRoot()."password-dimenticata";?>'><?php echo gtextPlain("indirizzo web", false);?></a>) <?php echo $alertAnonimo;?>
