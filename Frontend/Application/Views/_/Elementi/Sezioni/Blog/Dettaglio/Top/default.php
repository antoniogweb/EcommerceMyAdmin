...
<?php
$noNumeroProdotti = $noTitolo = $noContainer = $noImmagineSfondo = true;
...
<section class="uk-section uk-article uk-text-left uk-padding-remove-top">
	<div class="uk-container uk-container-small">
		...
		<p class="uk-article-meta"><?php echo gtextPlain("Scritto in data");?> <?php echo traduci(date("d M Y", strtotime($p["pages"]["data_news"])), true);?>. <?php echo gtextPlain("Categoria");?> <a href="<?php echo $this->baseUrl."/$urlAliasCategoria";?>"><?php echo cfield($p, "title");?></a></p>
