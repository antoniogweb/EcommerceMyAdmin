...
<div class="uk-card uk-card-default uk-card-small" style="box-shadow: none;">
	<div class="uk-card-media-top">
		<a href="<?php echo $this->baseUrl."/".$urlAlias;?>"><img src="<?php echo $this->baseUrlSrc."/thumb/blog/".$p["pages"]["immagine"];?>" alt="<?php echo altUrlencode(field($p, "title"));?>"></a>
	</div>
	<div class="uk-card-header">
		...
		<?php if ($p["pages"]["data_news"]) { ?>
		<p class="uk-text-meta uk-margin-remove uk-text-small"><time datetime="<?php echo date("Y-m-d H:i:s", strtotime($p["pages"]["data_news"]));?>"><?php echo traduci(date("d M Y", strtotime($p["pages"]["data_news"])), true);?></time></p>
		<?php } ?>
	</div>
