...
<?php
$ultimiEventi = EventiModel::getElementiFascia(3);

if (isset($ultimiEventi) && count($ultimiEventi) > 0) { ?>
			...
			<div class="uk-position-relative">
				<div class="uk-slider-container">
					<ul class="uk-slider-items uk-child-width-1-2@s uk-child-width-1-3@m uk-grid uk-grid-medium">
						<?php foreach ($ultimiEventi as $p) { ?>
						<li tabindex="-1" class="" style="order: 1;">
							<?php include(tpf("/Elementi/Categorie/evento.php"));?>
						</li>
						<?php } ?>
					</ul>
				</div>
