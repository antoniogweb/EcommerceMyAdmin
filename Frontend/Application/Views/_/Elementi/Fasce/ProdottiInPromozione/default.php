...
<!-- 		<div class="uk-text-center uk-text-uppercase uk-text-lead uk-text-small"><?php echo gtextPlain("Prodotti in"); ?></div> -->
		<h2 class="uk-text-bold uk-text-center uk-margin-remove-top uk-margin-remove-bottom"><span><?php echo gtextPlain("Promozione"); ?></span></h2>
			...
			<div class="uk-width-1-1 uk-width-1-2@m">
				<div class="uk-inline-clip uk-transition-toggle">
					...
					<div class="uk-text-center uk-position-small uk-position-top uk-overlay uk-overlay-default">
						...
						<a class="uk-button uk-button-secondary uk-margin" href="<?php echo $this->baseUrl."/".CategoriesModel::getUrlAliasPromo();?>"><?php echo gtextPlain("Vedi tutti");?></a>
					</div>
				</div>
			</div>
