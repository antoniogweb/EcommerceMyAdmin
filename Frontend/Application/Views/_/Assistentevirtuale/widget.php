...
<div class="assistente_virtuale_widget" data-chat-url="<?php echo $this->baseUrl.'/virtual-assistant/';?>">
	...
	<button
		...
		aria-expanded="false"
		aria-label="<?php echo gtextPlain("Apri la chat con l'assistente virtuale");?>">
		...
		<span class="assistente_virtuale_widget_toggle_text"><?php echo gtextPlain('ChatBot');?></span>
	</button>
	<?php } ?>
	...
	<section
		...
		<header class="assistente_virtuale_widget_header">
			<div class="assistente_virtuale_widget_header_text">
				<strong><?php echo gtextPlain('Assistente virtuale');?></strong>
				<span><?php echo gtextPlain('Risposte immediate su prodotti, ordini e supporto');?></span>
			</div>
			<button
				class="assistente_virtuale_widget_close"
				type="button"
				aria-label="<?php echo gtextPlain('Chiudi la chat');?>">
		...
		<div class="assistente_virtuale_widget_body">
			<iframe
				...
				title="<?php echo gtextPlain('Chat assistente virtuale');?>"
				loading="lazy"
