...
<div class="assistente_virtuale_widget" data-chat-url="<?php echo $this->baseUrl.'/virtual-assistant/';?>">
	...
	<button
		...
		aria-expanded="false"
		aria-label="<?php echo gtextAttr("Apri la chat con l'assistente virtuale");?>">
	...
	<section
		...
		<header class="assistente_virtuale_widget_header">
			...
			<button
				...
				type="button"
				aria-label="<?php echo gtextAttr('Chiudi la chat');?>">
		...
		<div class="assistente_virtuale_widget_body">
			<iframe
				...
				title="<?php echo gtextAttr('Chat assistente virtuale');?>"
				loading="lazy"
