...
<div class="<?php echo v("alert_error_class");?>"><?php echo gtextPlain("Attenzione, alcune righe nel tuo carrello hanno una quantità maggiore di quella presente a magazzino.")?></div>
<?php } ?>
...
<div class="<?php echo v("alert_error_class");?>"><?php echo gtextPlain("Attenzione, controllare i campi evidenziati relativi alle Gift Card.");?></div>
<?php } ?>
<?php if (!hasActiveCoupon() && PromozioniModel::$erroreCouponUtente) { ?>
<div class="<?php echo v("alert_error_class");?>"><?php echo gtextPlain(PromozioniModel::$erroreCouponUtente);?></div>
<?php } ?>