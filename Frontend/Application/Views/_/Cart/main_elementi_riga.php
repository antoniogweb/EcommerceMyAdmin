<?php if (!defined('EG')) die('Direct access not allowed!'); ?>
			<?php if ($p["cart"]["gift_card"]) {
				...
				<div class="form_elemento_gift_card uk-margin-top uk-padding-small uk-padding-remove-right elemento_gift_card" id-cart="<?php echo $p["cart"]["id_cart"];?>">
					<div class="uk-grid-small uk-child-width-1-1@m uk-child-width-1-2 uk-child-width-1-5@m uk-child-width-2-4 <?php if (!User::$isMobile) { ?>uk-flex-middle<?php } ?> uk-grid" uk-grid="">
								...
								<div class="uk-form-controls">
									<div class="uk-grid uk-grid-column-small" uk-grid>
										<div class="uk-margin uk-margin-remove-bottom uk-width-1-1 uk-width-2-3@m">
											<?php echo Html_Form::input("email",$elCart["email"],"uk-input");?>
										</div>
