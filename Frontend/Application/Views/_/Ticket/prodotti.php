...
<div class="box_prodotti_inner">
	...
	<div class="uk-text-primary uk-text-bold uk-margin-bottom-small"><?php echo gtextPlain("Seleziona e aggiugni un prodotto per cui chiedi assistenza");?></div>
	...
	<div class=" uk-text-primary uk-text-bold uk-margin-bottom-small"><?php echo gtextPlain("Prodotti aggiunti al ticket");?></div>
