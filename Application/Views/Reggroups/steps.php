...
<ul class="nav_dettaglio nav nav-tabs">
	...
	<li <?php echo $posizioni['tipi'];?>><a class="help_ordini" href="<?php echo $this->baseUrl."/".$this->controller."/tipi/$id".$this->viewStatus;?>"><?php echo gtextPlain("Accesso contenuti");?></a></li>
	<?php } ?>
</ul>
