...
<ul class="nav_dettaglio nav nav-tabs">
	...
	<?php if (v("abilita_traduzioni_documenti")) { ?>
		...
		<li <?php if (isset($id_ct) && (int)$tr["id_ct"] === (int)$id_ct) { ?>class="active"<?php } ?>><a href="<?php echo $this->baseUrl."/".$this->applicationUrl.$this->controller."/traduzione/$id/".$tr["id_ct"].$this->viewStatus;?>"><?php echo strtoupper($tr["lingua"]);?></a></li>
		<?php } ?>
	<?php } ?>
</ul>
