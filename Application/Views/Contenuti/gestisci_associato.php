...
<?php if ($this->action == "figli") { ?>
	<p>
		<a class="btn btn-info" href="<?php echo $this->baseUrl."/contenuti/form/insert/0?id_fascia=$id&partial=Y&tipo=GENERICO&id_tipo=".$this->viewArgs["id_tipo_figlio"]."&id_tipo_figlio=".$this->viewArgs["id_tipo_figlio"];?>"><i class="fa fa-plus"></i> <?php echo gtextPlain("Nuovo elemento");?></a>
	</p>
<?php } ?>
