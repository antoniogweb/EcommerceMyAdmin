...
<div class="box_thumb" data-id="<?php echo $records[$i]['immagini']['id_immagine'];?>">
	...
	<div class="box_thumb_up">
		<a title="<?php echo gtext("elimina l'immagine");?>" class="a_del pull-right" href="<?php echo $this->baseUrl.'/immagini/erase/'.$records[$i]['immagini']['id_immagine'];?>?csrf=<?php echo User::$csrfToken;?>"><i class="fa fa-trash" aria-hidden="true"></i></a>
		...
		<a title="<?php echo gtext("ruota in senso orario");?>" class="a_rotate_o" href="<?php echo $this->baseUrl.'/immagini/rotateo/'.$records[$i]['immagini']['id_immagine'];?>?csrf=<?php echo User::$csrfToken;?>"><i class="fa fa-repeat" aria-hidden="true"></i></a>
	</div>
