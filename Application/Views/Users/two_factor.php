...
<div id="ext_login">
	...
	<form action = '<?php echo $action;?>' method = 'POST' class="form-signin" role="form">
		...
		<br />
		<a class="btn btn-lg btn-info btn-block make_spinner" href="<?php echo $this->baseUrl."/".$this->applicationUrl.$this->controller."/login";?>"><i class="fa fa-arrow-left"></i> <?php echo gtext("Torna");?></a>
	</form>
