...
<ul class="nav_dettaglio nav nav-tabs">
	<li <?php echo $posizioni['main'];?>><a href="<?php echo $this->baseUrl."/".$this->applicationUrl.$this->controller."/vedi/$id".$this->viewStatus;?>"><?php echo gtextPlain("Dettagli");?></a></li>
	<li <?php echo $posizioni['integrazioni'];?>><a href="<?php echo $this->baseUrl."/".$this->applicationUrl.$this->controller."/integrazioni/$id".$this->viewStatus;?>">Invii a piattaforme esterne</a></li>
</ul>
...
<ul class="nav_dettaglio nav nav-tabs">
	...
	<li <?php echo $posizioni['righe'];?>><a href="<?php echo $this->baseUrl."/".$this->applicationUrl.$this->controller."/righe/$id".$this->viewStatus;?>"><?php echo gtextPlain("Righe ordine");?></a></li>
	<?php } ?>
</ul>
