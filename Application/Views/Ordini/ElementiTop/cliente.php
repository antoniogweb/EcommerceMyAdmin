...
<tr>
	...
	<td>
		<a title="<?php echo gtextAttr("Apri il dettaglio del cliente dell'ordine");?>" class="pull-right iframe badge badge-info" href="<?php echo $this->baseUrl."/$urlClienti/form/update/".$cliente["id_user"]?>?partial=Y&nobuttons=Y"><i class="fa fa-user"></i> <?php echo gtext("dettagli");?></a>
