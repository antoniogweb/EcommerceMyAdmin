...
<section class="content-header">
	<h1><?php echo gtextPlain("Script del Pixel");?> <?php echo $record_evento["pixel"]["titolo"];?></h1>
</section>
		...
		<div class="col-md-12">	
			<div class="box">
				<div class="box-header with-border main help_resoconto">
					<h2><?php echo gtextPlain("Codice script");?></h2>
					<pre>
						<?php echo $record_evento["pixel_eventi"]["codice_evento"];?></h1>
					</pre>
					
					<h2><?php echo gtextPlain("Codice noscript");?></h2>
					<pre>
