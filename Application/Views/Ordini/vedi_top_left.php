...
<table class="table table-striped">
	...
	?>
		...
		<tr>
			...
			<td>
				<a title="<?php echo gtext("Apri il dettaglio del cliente dell'ordine");?>" class="pull-right iframe label label-success" href="<?php echo $this->baseUrl."/$urlClienti/form/update/".$cliente["id_user"]?>?partial=Y"><i class="fa fa-user"></i> <?php echo gtext("dettagli");?></a>
