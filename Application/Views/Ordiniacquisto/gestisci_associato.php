	...
	<?php if (ControllersModel::checkAccessoAlController(array("magazzinoarticoli"))) { ?>
		<?php if (OrdiniacquistoModel::g()->isBozza($id)) { ?>
			<div>
				...
				<a style="margin-left:5px;" id-ordine="<?php echo $id;?>" id-riga-tipologia="0" class="aggiungi_riga_tipologia_ordine_acquisto make_spinner pull-right btn btn-sm btn-default" href="<?php echo $this->baseUrl."/ordiniacquistorighe/form/insert/0";?>"><i class="fa fa-plus"></i> <?php echo gtextPlain("Riga libera");?></a>
			...
			<br />
		<?php } else { ?>
			<div class="callout callout-info"><?php echo gtextPlain("Le righe dell'ordine non sono modificabili in quanto l'ordine non è più in stato di Bozza oppure ha delle ricezioni collegate");?></b></div>
		<?php } ?>
	<?php } ?>
<?php } ?>
