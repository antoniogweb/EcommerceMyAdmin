...
<ul class="nav_dettaglio nav nav-tabs">
	...
	?>
	<li <?php echo $posizioni['main'];?>><a href="<?php echo $this->baseUrl."/".$this->controller."/form/update/$id_page".$viewStatusTutti;?>"><?php echo gtextPlain("Dettagli");?></a></li>
	...
	<li <?php echo $posizioni['testi'];?>><a href="<?php echo $this->baseUrl."/".$this->controller."/testi/$id_page".$viewStatusTutti;?>"><?php echo gtextPlain("Contenuti");?></a></li>
	<?php } ?>
	<li <?php echo $posizioni['immagini'];?>><a href="<?php echo $this->baseUrl."/".$this->controller."/immagini/$id_page".$viewStatusTutti;?>"><?php echo gtextPlain("Immagini");?></a></li>
	<li <?php echo $posizioni['meta'];?>><a href="<?php echo $this->baseUrl."/".$this->controller."/meta/$id_page".$viewStatusTutti;?>"><?php echo gtextPlain("Meta");?></a></li>
	<?php if (v("correlati_in_prodotti")) { ?>
	<li <?php echo $posizioni['prod_corr'];?>><a href="<?php echo $this->baseUrl."/".$this->controller."/correlati/$id_page".$viewStatusTutti;?>"><?php echo gtextPlain("Notizie correlate");?></a></li>
	<?php } ?>
	<?php if (v("mostra_link_in_blog")) { ?>
	<li <?php echo $posizioni['link'];?>><a href="<?php echo $this->baseUrl."/".$this->controller."/link/$id_page".$viewStatusTutti;?>"><?php echo gtextPlain("Link");?></a></li>
	<?php } ?>
