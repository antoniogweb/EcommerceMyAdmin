...
<ul class="nav_dettaglio nav nav-tabs">
	...
	<li <?php echo $posizioni['spedizioni'];?>><a href="<?php echo $this->baseUrl."/".$this->controller."/spedizioni/$id".$this->viewStatus;?>"><?php echo gtext("Indirizzi di spedizione");?></a></li>
	<?php if (v("ecommerce_attivo")) { ?>
	<li <?php echo $posizioni['ordini'];?>><a href="<?php echo $this->baseUrl."/".$this->controller."/ordini/$id".$this->viewStatus;?>"><?php echo gtext("Ordini");?></a></li>
	<?php } ?>
