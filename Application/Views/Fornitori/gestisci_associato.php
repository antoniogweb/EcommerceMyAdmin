...
<?php if ($this->action == "contatti") { ?>
	<p><a class="iframe btn btn-success" href="<?php echo $this->baseUrl."/fornitoricontatti/form/insert";?>?partial=Y&nobuttons=N&id_fornitore_insert=<?php echo $id;?>"><i class="fa fa-plus-circle"></i> <?php echo gtext("Aggiungi contatto");?></a></p>
<?php } ?>
