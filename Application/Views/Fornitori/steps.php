...
<ul class="nav_dettaglio nav nav-tabs">
	...
	<li <?php echo $posizioni['import'];?>><a href="<?php echo $this->baseUrl."/".$this->applicationUrl.$this->controller."/import/$id".$this->viewStatus;?>"><?php echo gtext("Import listini");?></a></li>
</ul>
