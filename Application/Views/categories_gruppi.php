...
<section class="content-header">
	...
	<h1><?php echo gtextPlain("Gestione")." $tabella";?>: <?php echo $titoloPagina;?></h1>
	<?php } else { ?>
		...
		<div class="col-md-12">
			...
			<div class="box">
				<div class="box-header with-border main">
					...
					<div class="callout callout-warning"><?php echo gtextPlain("La categoria è accessibile solo agli utenti che appartengono ad uno dei seguenti gruppi.");?></div>
					
					<?php } else {  ?>
					<div class="callout callout-info"><?php echo gtextPlain("La categoria è accessibile a tutti.");?></div>
					<?php } ?>
