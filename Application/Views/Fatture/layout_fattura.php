...
<page backtop="67mm" backbottom="7mm" backleft="10mm" backright="10mm" style="font-size:12px;">
	<page_header>
		<div style="height:151px;margin-bottom:40px;text-align:center;">
			<br />
			<br /><b>Lian s.a.s. di Marco Cappellari & C.</b><br />
			Father & Son<br />
			via Lombardia, 4 - 35020 Saonara (PD) - info@fathersonlighting.it
			<br />P.IVA e C.F.: 03576000289
		</div>
	</page_header>
	...
	<!--<page_footer>
		<div style="padding:10px;height:50px;background-color:#50ade5;color:#FFF;text-align:center;">
			Lian snc, Via Arrigoni 53/d, Peraga di Vigonza (PD)<br />
			Iscritta presso la Camera di commercio di Padova al n. 03576000289 del Registro delle imprese<br />
			codice fiscale n. 03576000289, partita IVA n. IT03576000289
		</div>
	</page_footer>-->
</page>
