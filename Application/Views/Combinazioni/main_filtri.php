...
<div class="panel panel-info">
	<div class="panel-heading">
		<?php echo gtextPlain("Modifica di gruppo");?>
	</div>
	<div class="panel-body">
		<form class="form-inline form-modifica-massiva">
			...
			<button class="btn btn-success btn-imposta-gruppo"><?php echo gtextPlain("Imposta");?></button>
		</form>
	</div>
</div>
...
<div class="callout callout-warning">
	<?php echo gtextPlain("Il listino")." <b>(".findTitoloDaCodice($this->viewArgs["listino"]).")</b> ".gtextPlain("non è sincronizzato con quello di default")." <b>(".findTitoloDaCodice(v("nazione_default")).")</b>.";?>
	<a style="text-decoration:none;" class="badge badge-default pull-right" href="<?php echo $this->baseUrl."/combinazioni/main".$this->viewStatus."&sincronizza";?>"><?php echo gtextPlain("Sincronizza il listino");?></a>
</div>
<?php } ?>
