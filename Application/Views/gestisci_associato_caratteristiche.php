...
<a class="btn btn-success iframe help_aggiungi_caratteristiche pull-right" href="<?php echo $this->baseUrl."/caratteristichevalori/main?id_page=$id_page&partial=Y&cl_on_sv=Y&id_tipo_car=".$this->viewArgs["id_tipo_car"];?>"><i class="fa fa-pencil"></i> <?php echo gtextPlain("Gestisci caratteristiche");?></a>
