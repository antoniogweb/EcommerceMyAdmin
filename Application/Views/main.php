...
<section class="content-header">
	<h1>Gestione <?php echo $tabella;?> <?php if ($helpDaVedereTutti) { ?><small class="pull-right"><a class="label label-default" target="_blank" href="<?php echo $this->baseUrl."/help/pdf/0/".$this->controller;?>"><i class="fa fa-question-circle"></i> <?php echo gtext("Scarica guida")?></a></small><?php } ?></h1>
</section>
