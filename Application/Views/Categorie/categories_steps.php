...
<ul class="nav_dettaglio nav nav-tabs">
	...
	<?php if (v("fasce_in_categorie")) { ?>
		<li <?php echo $posizioni['contenuti'];?>><a href="<?php echo $this->baseUrl."/".$this->applicationUrl.$this->controller."/contenuti/$id".$this->viewStatus;?>"><?php echo gtextPlain("Fasce");?></a></li>
	<?php } ?>
	<li <?php echo $posizioni['meta'];?>><a class="help_meta" href="<?php echo $this->baseUrl."/".$this->applicationUrl.$this->controller."/meta/$id".$this->viewStatus;?>"><?php echo gtextPlain("Meta");?></a></li>
	...
	<?php if (v("ecommerce_attivo") && v("attiva_classi_sconto") && ClassiscontoModel::g()->rowNumber() > 0) { ?>
		<li <?php echo $posizioni['classisconto'];?>><a href="<?php echo $this->baseUrl."/".$this->applicationUrl.$this->controller."/classisconto/$id".$this->viewStatus;?>"><?php echo gtextPlain("Classi sconto applicate");?></a></li>
	<?php } ?>
	...
	<li <?php echo $posizioni['caratteristiche'];?>><a href="<?php echo $this->baseUrl."/".$this->applicationUrl.$this->controller."/caratteristiche/$id".$this->viewStatus;?>"><?php echo gtextPlain("Filtri");?></a></li>
	<?php } ?>
	<?php if (v("attiva_limitazione_spedizione_nazioni")) { ?>
	<li <?php echo $posizioni['nazioni'];?>><a href="<?php echo $this->baseUrl."/".$this->applicationUrl.$this->controller."/nazioni/$id".$this->viewStatus;?>"><?php echo gtextPlain("Nazioni spedizione");?></a></li>
	<?php } ?>
</ul>
