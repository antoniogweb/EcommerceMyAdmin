...
<ul class="nav_dettaglio nav nav-tabs">
  ...
  <li <?php echo $posizioni['immagini'];?> ><a class="help_immagini" href="<?php echo $this->baseUrl."/".$this->applicationUrl.$this->controller."/immagini/$id_page".$this->viewStatus;?>"><?php echo gtextPlain("Immagini");?></a></li>
  <?php } ?>
</ul>
