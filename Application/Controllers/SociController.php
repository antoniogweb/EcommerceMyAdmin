...
class SociController extends GenericsectionController {
	
	public $voceMenu = "soci";
	...
	public function __construct($model, $controller, $queryString = array(), $application = null, $action = null)
	{
		...
		$this->queryFields = "title,attivo,description,immagine,video,sottotitolo,link_pagina_facebook,link_pagina_twitter,link_pagina_youtube,email_contatto_evento,telefono_contatto_evento,indirizzo_localita_evento,localita_evento,id_regione";
	}
}
