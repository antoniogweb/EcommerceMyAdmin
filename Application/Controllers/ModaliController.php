...
class ModaliController extends GenericsectionController {
	
	public $voceMenu = "modali";
	...
	public function __construct($model, $controller, $queryString = array(), $application = null, $action = null)
	{
		...
		$this->queryFields = "title,attivo,immagine,immagine_2,sottotitolo,description,url,link_id_page,link_id_c,testo_link,giorni_durata_modale,template_modale,go_to,apri_dopo_secondi";
