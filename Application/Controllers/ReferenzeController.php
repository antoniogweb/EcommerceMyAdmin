...
class ReferenzeController extends PagesController {

	public $voceMenu = "referenze";
	...
	function __construct($model, $controller, $queryString) {
		...
		$this->queryFields = "title,alias,attivo,description,immagine,data_news,codice_nazione,coordinate";
