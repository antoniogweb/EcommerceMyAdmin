...
class IpcheckerController extends BaseController
{
	...
	function __construct($model, $controller, $queryString, $application, $action) {
		...
		if (!v("attiva_gestione_ipchecker"))
	...
	public function main()
	{
		...
		$this->mainFields = array("edit","ip_checker.codice","attivo");
	...
	public function form($queryType = 'insert', $id = 0)
	{
		...
		$fields = IpcheckerModel::getModulo($record["codice"])->gCampiForm();
