...
class TraduttoriController extends BaseController
{
	...
	public function main()
	{
		...
		$this->mainFields = array("edit","traduttori.codice","attivo");
	...
	public function form($queryType = 'insert', $id = 0)
	{
		...
		$fields = TraduttoriModel::getModulo($record["codice"])->gCampiForm();
