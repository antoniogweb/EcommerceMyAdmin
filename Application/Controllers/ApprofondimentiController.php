...
class ApprofondimentiController extends GenericsectionController {
	
	public $voceMenu = "approfondimenti";
...
// 			'<a href="'.$this->baseUrl.'/'.$this->controller.'/form/update/;pages.id_page;'.$this->viewStatus.'">;PagesModel.getThumb|pages.id_page;</a>',
		...
		$this->queryFields = "title,attivo,description,immagine,sottotitolo,alias,use_editor";
