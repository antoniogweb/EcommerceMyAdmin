...
// 		"redirect_pagina_dopo_invio_se_prodotto"	=>	0, // se attivo, l'utente viene reindirizzato alla pagina del prodotto dopo l'invio
		...
		"attiva_note_su_promo"		=>	0, // se impostato a 1, attiva le note sulle promozioni
		## CARRELLO ##
		...
		"attiva_limitazione_spedizione_nazioni"	=>	0, // se impostato su 1 sarà possibile da pannello limitare la spedizione del prodotto ad alcune specifiche nazioni (tabelle pages_nazioni e categories_nazioni)
		## CORRIERI ##
		...
		"hook_ordine_pagato"		=>	"", // se diversa da blank, funzione che viene chiamata dopo che l'ordine è stato pagato online (dopo IPN). Gli viene passato l'ID dell'ordine come unico parametro
		### GDPR ##
		...
		"numero_massimo_ticket_ip_ogni_giorno"	=>	1, // Numero massimo di ticket permessi per ogni IP al giorno
		...
		"attiva_url_esterno_documento"	=>	0, // se impostato a 1, sarà attivo il campo link_to_url che se riempito genererà un redirect all'url quado si prova a scaricare il documento
		### MAIL LOG ##
