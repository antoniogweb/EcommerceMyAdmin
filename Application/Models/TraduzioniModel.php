...
class TraduzioniModel extends GenericModel {
	...
	public function getTraduzione($chiave, $function = "none", $contesto = null)
	{
		...
		if (count($res) > 0)
		{
			...
			return "<span class='blocco_traduzione'>".sanitizeHtmlLight(stripTagsSicuro($valore))."<img $href data-id='".$res["id_t"]."' class='edit_traduzione $iframe' src='".Url::getFileRoot()."Public/Img/mini-plus.jpg' /></span>";
		}
