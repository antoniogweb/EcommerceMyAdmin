...
class RegusersgroupstempModel extends GenericModel {
    ...
    {
		return "<i data-azione='approvagruppi' title='".gtextAttr("Approva tutto")."' class='bulk_trigger fa fa-thumbs-up text text-success'></i>";
    }
    
    public function approvasoloaccountcrud($record)
    {
		return "<i data-azione='approvasoloaccountgruppi' title='".gtextAttr("Approva solo attivazione account")."' class='bulk_trigger fa fa-thumbs-up text text-info'></i>";
    }
