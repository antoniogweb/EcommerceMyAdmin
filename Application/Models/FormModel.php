...
// 					'options'	=>	array('pending'=>'In lavorazione','completed'=>'Completo','deleted'=>'Eliminato'),
				...
				'tipo_cliente'		=>	array(
					...
					'options'	=>	gtextDeep(TipiclientiModel::getArrayTipi()),
...
// 					),
				...
				'provincia'		=>	array(
					...
					'className'	=>	'for_print form-control',
					'options'	=>	ProvinceModel::g()->selectTendina("nazione"),
					'reverse' => 'yes',
				...
				'provincia_spedizione'	=>	array(
					...
					'className'	=>	'for_print form-control',
					'options'	=>	ProvinceModel::g()->selectTendina("nazione_spedizione"),
					'reverse' => 'yes',
...
// 				),
				...
				'genere'	=>	array(
					"type"	=>	"Select",
					"options"	=>	array("" => "Seleziona", "M" => gtext("Maschio"), "F" => gtext("Femmina")),
					"reverse"	=>	"yes",
					"className"	=>	"form-control",
				),
			),
