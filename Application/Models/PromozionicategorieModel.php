...
class PromozionicategorieModel extends GenericModel {
	...
	public function insert()
	{
		...
		if (!empty($cat))
		{
			...
			else
			{
				...
				$fraseErrore = $includi ? "Hai già alcune categorie in esclusione, non puoi aggiungerne in inclusione" : "Hai già alcune categorie in inclusione, non puoi aggiungerne in esclusione";
	...
	{
		if ($record["promozioni_categorie"]["includi"])
