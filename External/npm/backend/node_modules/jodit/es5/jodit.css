...
.jodit-progress-bar__file-animation {
  ...
  -webkit-transform: scale(1);
      -ms-transform: scale(1);
          transform: scale(1);
  -webkit-transition: left 800ms ease-in, top 800ms ease-in, opacity 800ms ease-in, -webkit-transform 800ms ease-in;
  transition: left 800ms ease-in, top 800ms ease-in, opacity 800ms ease-in, -webkit-transform 800ms ease-in;
  transition: left 800ms ease-in, top 800ms ease-in, opacity 800ms ease-in, transform 800ms ease-in;
  transition: left 800ms ease-in, top 800ms ease-in, opacity 800ms ease-in, transform 800ms ease-in, -webkit-transform 800ms ease-in;
}
...
.jodit .jodit-select {
  ...
  background-position: right calc(8px / 2) center;
  background-repeat: no-repeat;
