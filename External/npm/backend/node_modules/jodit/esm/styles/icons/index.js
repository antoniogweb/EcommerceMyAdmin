...
import download from "./download.svg.js";
...
export { angle_down, angle_left, angle_right, angle_up, bin, cancel, center, check, chevron, dots, download, eye, file, folder, info_circle, left, lock, ok, pencil, plus, resize_handler, right, save, settings, unlock, update, upload, valign };
