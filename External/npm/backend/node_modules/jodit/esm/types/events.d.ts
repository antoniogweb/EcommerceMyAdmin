...
interface IEventEmitter extends IDestructible {
    ...
    on(subject: CanArray<Window | HTMLElement | object>, events: CanArray<string>, callback: CallbackFunction, options?: IEventEmitterOnOptions): this;
    one(events: CanArray<string>, callback: CallbackFunction, options?: IEventEmitterOnOptions): this;
    one(subject: CanArray<Window | HTMLElement | object>, events: CanArray<string>, callback: CallbackFunction, options?: IEventEmitterOnOptions): this;
    /**
    ...
    off(subjects: CanArray<Window | HTMLElement | object>, events?: CanArray<string>, callback?: CallbackFunction): IEventEmitter;
