...
class Debug extends jodit_core_plugin_plugin__WEBPACK_IMPORTED_MODULE_3__.Plugin {
    afterInit(jodit) {
        ...
        jodit_core_dom_dom__WEBPACK_IMPORTED_MODULE_1__.Dom.append(mirror, tree);
        jodit_core_dom_dom__WEBPACK_IMPORTED_MODULE_1__.Dom.append(mirror, events);
        jodit_core_dom_dom__WEBPACK_IMPORTED_MODULE_1__.Dom.append(events, clear);
        jodit_core_dom_dom__WEBPACK_IMPORTED_MODULE_1__.Dom.append(mirror, sel);
        clear.addEventListener('click', ()=>{
            jodit_core_dom_dom__WEBPACK_IMPORTED_MODULE_1__.Dom.detach(events);
            jodit_core_dom_dom__WEBPACK_IMPORTED_MODULE_1__.Dom.append(events, clear);
        });
        jodit_core_dom_dom__WEBPACK_IMPORTED_MODULE_1__.Dom.append(jodit.workplace, mirror);
        const allEvents = [
            'activate',
            'afterInit',
            'beforeactivate',
        ...
        function onSomeEvent(e) {
            ...
            jodit_core_dom_dom__WEBPACK_IMPORTED_MODULE_1__.Dom.append(events, div);
            events.scrollTop = events.scrollHeight;
            jodit.async.setTimeout(()=>{
                events.children.length > 100 && jodit_core_dom_dom__WEBPACK_IMPORTED_MODULE_1__.Dom.safeRemove(events.children[0]);
            }, 100);
        }
