...
class RecognizeManager extends jodit_core_event_emitter_eventify__WEBPACK_IMPORTED_MODULE_3__.Eventify {
    ...
    destruct() {
        this.stop();
        (0,_sound__WEBPACK_IMPORTED_MODULE_4__.closeSound)(this);
    ...
    _makeSound(frequency) {
        if (this.sound) {
            (0,_sound__WEBPACK_IMPORTED_MODULE_4__.sound)(this, {
                frequency
            });
        }
    }
...
function getContext(owner) {
    ...
    const Ctor = jodit_core_constants__WEBPACK_IMPORTED_MODULE_0__.globalWindow.AudioContext || jodit_core_constants__WEBPACK_IMPORTED_MODULE_0__.globalWindow.webkitAudioContext;
    if (!Ctor) {
        return null;
    }
...
class SpeechRecognizeNative extends jodit_core_plugin__WEBPACK_IMPORTED_MODULE_6__.Plugin {
    ...
    onSpeechRecognizeProgressResult(text) {
        ...
        jodit_core_dom_dom__WEBPACK_IMPORTED_MODULE_3__.Dom.append(this.j.workplace, this.messagePopup);
