...
export interface IStyleOptions {
    ...
    hooks?: {
        ...
        beforeToggleList?(mode: CommitMode, style: ICommitStyle, list: HTMLElement): void | CommitMode;
        beforeUnwrapList?(mode: 'unwrap' | 'replace', list: HTMLElement, style: ICommitStyle): void | HTMLElement;
        afterToggleList?(mode: CommitMode, list: HTMLElement, style: ICommitStyle): void;
        afterToggleAttribute?(mode: CommitMode, elm: HTMLElement, key: string, value?: string | number | null | boolean): void;
    };
}
