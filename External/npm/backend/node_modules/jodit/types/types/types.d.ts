...
export type NodeCondition<T extends Node = Node> = (node: Nullable<T>) => boolean | null | false | void | '';
/**
 * Bound interface
 */
...
export type ExecCommandCallback<T, C extends string> = ((this: T, command: C, value?: string, next?: any, ...args: unknown[]) => void | boolean | Promise<void | boolean>) | ((this: T, command: C, value: string, next: string, ...args: unknown[]) => void | boolean | Promise<void | boolean>);
